...
public class RepEspacee extends PathHolder{
	...
	public void modifProfil(String nomProfil, int nbNiveau, int nbCartesAjouter, long joursApp,boolean lectureDone){
		/*
	...
	public String getDayDate() {
		DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy/ss");
		// les secondes ont ete rajouté dans le but de faire des tests rapide;
